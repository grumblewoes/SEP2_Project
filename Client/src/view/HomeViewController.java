...
public class HomeViewController extends ViewController
{
      ...
      Region root)
  {
    ...
    homeViewModel.getFriendshipListProperty()
  ...
  private void populateFriendships(String friendListJson)
  {
    ...
    ArrayList<String> requests = gson.fromJson(friendRequestList.get(),
        ArrayList.class);
    ...
    if (requests != null)
      for (int i = 0; i < friends.size(); ++i)
      {
        ...
        friendshipBox.getChildren().add(
            createFriendComponent(friend.getUsername(), friend.getStatus()));
      }
