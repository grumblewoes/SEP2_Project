...
public class ModelManager implements Model//, PropertyChangeListener
{
  ...
  {
    return client.createUser(firstName, lastName, userName, password, height,
        weight);
  }
  ...
  {
    return client.addExercise(username, exerciseName, folderId, weight,
        repetitions);
  }
  ...
  {
    return client.updateTrainee(u, h, w, s);
  }
